...
**¿Cuál de estos comandos debes ejecutar en PowerShell (como Administrador) para habilitar WSL e instalar Ubuntu?**
...
**¿Cuál es la secuencia correcta para descargar y convertir datos del SRA?**
...
1.  Extraiga los accession numbers (columna `Run`) de las muestras *Homo sapiens* en condición **"treated"**
2.  Descargue los FASTQs correspondientes en paralelo (máx. 3 simultáneos)
3.  Verifique la integridad de cada descarga
4.  Genere un reporte con: accession, número de reads, tamaño del archivo
